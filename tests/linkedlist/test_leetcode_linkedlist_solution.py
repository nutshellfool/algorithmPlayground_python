...
class TestLeetCodeSolution(TestCase):
    ...
    def test_deleteDuplicates2(self):
        ...
        list.append_node_to_tail(1)
        list.append_node_to_tail(2)
        list.append_node_to_tail(3)
        list.append_node_to_tail(3)
        list.append_node_to_tail(4)
        list.append_node_to_tail(4)
        list.append_node_to_tail(5)
        head = self.solution.deleteDuplicates2(list.head.next)
        self.assertIsNotNone(head)
        self.assertEqual(1, head.value)
        self.assertEqual(2, head.next.value)
        self.assertEqual(5, head.next.next.value)
        self.assertIsNone(head.next.next.next)
